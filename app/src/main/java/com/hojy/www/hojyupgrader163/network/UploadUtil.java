...
public class UploadUtil {
    ...
    public void uploadFile(final File file, final String fileKey,
        ...
        HojyLoger.i(TAG, "请求的URL=" + RequestURL);
        HojyLoger.i(TAG, "请求的fileName=" + file.getName());
        HojyLoger.i(TAG, "请求的fileKey=" + fileKey);
 ...
 */
            ...
            sb.append("Content-Type:image/x-zip-compressed" + LINE_END); // 这里配置的Content-type很重要的 ，用于服务器端辨别文件的类型的
            sb.append(LINE_END);
            params = sb.toString();
            sb = null;

            HojyLoger.i(TAG, file.getName()+"=" + params+"##");
            dos.write(params.getBytes());
/**上传文件*/
 ...
 */
            ...
            if (res == 200) {
                HojyLoger.e(TAG, "request success");
